      ...
      render={(props) => {
        ...
        if(getToken()){
          if(rest.access){
            ...
            // console.log('hasBuySideAccess:'+hasBuySideAccess);
            // console.log('had view access:'+rest.access+'--'+userPrivileges[default_terminal_type].indexOf(rest.access));
            // console.log('hasAPEXPrivilege', hasAPEXPrivilege);
