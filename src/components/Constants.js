...
export const API_WEBSOCKET_URL = (process.env.NODE_ENV === 'development')? "wss://support-dev-api.bydata.com/sight/" : "wss://support-api.bydata.com/sight/";
export const API_IASSIST_BASE_URL =  (process.env.NODE_ENV === 'development') ? "https://support-dev-api.bydata.com/sight/" : "https://support-api.bydata.com/sight/";
