...
console.log((process.env.NODE_ENV === 'development'), 'development' , (process.env.NODE_ENV === 'production') , 'production')
export let API_WEBSOCKET_URL;
export let API_IASSIST_BASE_URL;
if (!process.env.NODE_ENV || process.env.NODE_ENV === 'development') {
  ...
  API_WEBSOCKET_URL = "wss://support-api.bydata.com/sight/";
  API_IASSIST_BASE_URL =  "https://support-api.bydata.com/sight/";
}
// export let API_WEBSOCKET_URL = (process.env.NODE_ENV === 'production')? "wss://support-api.bydata.com/sight/" : "wss://support-dev-api.bydata.com/sight/";
// export let API_IASSIST_BASE_URL =  (process.env.NODE_ENV === 'production') ? "https://support-api.bydata.com/sight/" : "https://support-dev-api.bydata.com/sight/";
