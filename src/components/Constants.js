...
export const API_WEBSOCKET_URL = (process.env.NODE_ENV === 'production')? "wss://support-api.bydata.com/sight/" : "wss://support-dev-api.bydata.com/sight/";
export const API_IASSIST_BASE_URL =  (process.env.NODE_ENV === 'production') ? "https://support-api.bydata.com/sight/" : "https://support-dev-api.bydata.com/sight/";
